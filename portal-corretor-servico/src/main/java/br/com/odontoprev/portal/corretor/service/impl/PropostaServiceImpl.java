...
//			e.printStackTrace();
    ...
    public List<VwodCorretoraTotalVidasPF> findVwodCorretoraTotalVidasPFByFiltro(CorretoraTotalVidasPF corretoraTotalVidasPF) throws ParseException {
        ...
        if (corretoraTotalVidasPF.getDtVendaInicio().equals("0") && corretoraTotalVidasPF.getDtVendaFim().equals("0")) {
        ...
        return vwodCorretoraTotalVendasDAO.vwodCorretoraTotalVidasPFByFiltro(dateDtVendaInicio, dateDtVendaFim, corretoraTotalVidasPF.getCnpjCorretora());
    }
